...
<body style="padding:0px; margin:0px; background-color:#fff;font-family:helvetica, arial, verdana, sans-serif">
    ...
    <script src="<%=request.getContextPath()%>/js/jssor.slider-22.0.6.mini.js" type="text/javascript"></script>
       <style>
        ...
        */
        .jssora05l, .jssora05r {
            ...
            height: 40px;
            cursor: pointer;
            background: url('<%=request.getContextPath()%>/images/a17.png') no-repeat;
            overflow: hidden;
        }
	...
	/*making portlet body background black*/
         /*    .portlet-body{
            	background: black;
            	border-radius: 33px;
            }	   
        ...
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (refSize) {
                    ...
                    window.setTimeout(ScaleSlider, 15);
                }
            }
            ScaleSlider();
...
<%
	...
	if(folderID == null){
		...
		DLFolder dlFolder = DLFolderLocalServiceUtil.getFolder( Long.parseLong(folderID));
		if(dlFolder!=null){
			eventName = dlFolder.getName();
		}
	}
	
	List<DLFileEntry> fileEntries = DLFileEntryLocalServiceUtil.getFileEntries(groupId, Long.parseLong(folderID));
	String url = "";
%>
    ...
    <a class="btn btn-primary" href="/group/hr/image-gallery" style="margin-top:1em">Back</a>
</body>
