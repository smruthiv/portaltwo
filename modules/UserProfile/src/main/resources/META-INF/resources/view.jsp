...
<%
	...
	long companyId = (long)renderRequest.getAttribute("companyId");
	/* String backUrl = (String)renderRequest.getAttribute("backurl");
	System.out.println("Hi"+companyId); */
	User user1 = UserLocalServiceUtil.getUserByScreenName(companyId, screenName);
%>
